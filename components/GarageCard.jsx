...
import { Building2, Camera, Layers, Activity, Edit, Trash2 } from 'lucide-react'
...
export default function GarageCard({ garage }) {
  ...
  return (
    ...
    >
      <Card className="overflow-hidden hologram cursor-pointer group">
        {/* Thumbnail */}
        <div className="relative h-48 bg-gradient-to-br from-neon-blue/10 to-neon-purple/10 overflow-hidden">
          <div className="absolute inset-0 cyber-grid opacity-20" />
          <div className="absolute inset-0 flex items-center justify-center">
            <Building2 className="w-24 h-24 text-neon-blue/30 group-hover:text-neon-blue/50 transition-colors" />
          </div>
          {/* Status Badge */}
        ...
        <CardContent className="p-6">
          {/* Title */}
          <h3 className="text-xl font-bold mb-4 group-hover:text-neon-blue transition-colors">
            {garage.name}
          </h3>
